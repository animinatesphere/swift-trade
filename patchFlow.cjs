...
c = c.replace(
  ...
  `const COINS = [${NL}  { id:"USDT", name:"Tether",   icon:"₮", color:"#26A17B", bg:"rgba(38,161,123,0.15)",  networks:["TRC20","ERC20"] },${NL}  { id:"BTC",  name:"Bitcoin",  icon:"₿", color:"#F7931A", bg:"rgba(247,147,26,0.15)",  networks:["Bitcoin"]       },${NL}  { id:"ETH",  name:"Ethereum", icon:"Ξ", color:"#627EEA", bg:"rgba(98,126,234,0.15)",  networks:["ERC20"]         },${NL}  { id:"USDC", name:"USD Coin", icon:"◎", color:"#0072FF", bg:"rgba(0,114,255,0.15)",   networks:["ERC20","SOL"]   },${NL}  { id:"BNB",  name:"BNB",      icon:"⬡", color:"#F3BA2F", bg:"rgba(243,186,47,0.15)",  networks:["BEP20"]         },${NL}  { id:"SOL",  name:"Solana",   icon:"◎", color:"#9945FF", bg:"rgba(153,69,255,0.15)",  networks:["SOL"]           },${NL}];`
);
