...
const BRANDS = [
  {
    ...
    countries:[
      { code:"US", flag:"🇺🇸", currency:"USD", symbol:"$", rate:1380, denoms:[25,50,100,200] },
      { code:"UK", flag:"🇬🇧", currency:"GBP", symbol:"£", rate:1640, denoms:[25,50,100] },
    ],
    color:"#FF9900", bg:"linear-gradient(135deg,#1a0800,#3d1f00)",
    textColor:"rgba(255,153,0,0.8)",
  },
  {
    id:"itunes", name:"iTunes", icon:"🎵",
    countries:[
      { code:"US", flag:"🇺🇸", currency:"USD", symbol:"$", rate:1350, denoms:[15,25,50,100] },
      { code:"UK", flag:"🇬🇧", currency:"GBP", symbol:"£", rate:1560, denoms:[15,25,50] },
    ],
    color:"#FC3C44", bg:"linear-gradient(135deg,#1a001a,#330020)",
    textColor:"rgba(252,60,68,0.8)",
  },
  {
    id:"steam", name:"Steam", icon:"🎮",
    countries:[
      { code:"US", flag:"🇺🇸", currency:"USD", symbol:"$", rate:1300, denoms:[10,20,50,100] },
    ],
    color:"#66C0F4", bg:"linear-gradient(135deg,#00101a,#001f33)",
    textColor:"rgba(102,192,244,0.8)",
  },
  {
    id:"google", name:"Google Play", icon:"▶",
    countries:[
      { code:"US", flag:"🇺🇸", currency:"USD", symbol:"$", rate:1370, denoms:[10,25,50,100] },
    ],
    color:"#0ECB81", bg:"linear-gradient(135deg,#001a08,#003318)",
    textColor:"rgba(14,203,129,0.8)",
  },
  {
    id:"netflix", name:"Netflix", icon:"🎬",
    countries:[
      { code:"US", flag:"🇺🇸", currency:"USD", symbol:"$", rate:1300, denoms:[15,30,60,100] },
    ],
    color:"#E50914", bg:"linear-gradient(135deg,#1a0000,#330000)",
    textColor:"rgba(229,9,20,0.8)",
  },
  {
    id:"xbox", name:"Xbox", icon:"🕹",
    countries:[
      { code:"US", flag:"🇺🇸", currency:"USD", symbol:"$", rate:1280, denoms:[10,25,50,100] },
    ],
    color:"#107C10", bg:"linear-gradient(135deg,#001a00,#003300)",
    textColor:"rgba(16,124,16,0.8)",
  },
  {
    id:"visa", name:"Visa", icon:"💳",
    countries:[
      { code:"US", flag:"🇺🇸", currency:"USD", symbol:"$", rate:1260, denoms:[50,100,200,500] },
    ],
    color:"#6B8AFE", bg:"linear-gradient(135deg,#000818,#001433)",
    textColor:"rgba(107,138,254,0.8)",
  },
  {
    id:"razergold", name:"Razer Gold", icon:"⚡",
    countries:[
      { code:"US", flag:"🇺🇸", currency:"USD", symbol:"$", rate:1250, denoms:[5,10,25,50] },
    ],
    color:"#44D62C", bg:"linear-gradient(135deg,#001a00,#002800)",
...
function Mark({ size=32 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" style={{display:"block"}}>
      <defs>
        <filter id="gcg"><feGaussianBlur in="SourceGraphic" stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
        <filter id="gca"><feGaussianBlur in="SourceGraphic" stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
      </defs>
      <path d="M 32,52 C 26,40 16,24 8,8" stroke={C.green} strokeWidth="3.8" strokeLinecap="round" fill="none" filter="url(#gcg)"/>
      <g transform="translate(8,8) rotate(-27)"><polygon points="0,-6 -3.5,3.5 3.5,3.5" fill={C.green} filter="url(#gcg)"/></g>
      <path d="M 32,52 C 38,40 48,24 56,8" stroke={C.amber} strokeWidth="3.8" strokeLinecap="round" fill="none" filter="url(#gca)"/>
      <g transform="translate(56,8) rotate(27)"><polygon points="0,-6 -3.5,3.5 3.5,3.5" fill={C.amber} filter="url(#gca)"/></g>
  ...
  return (
    <div className="left-panel">
      <div className="left-panel-ambient" style={{ position:"absolute", top:-60, left:-60, width:300, height:300,
        borderRadius:"50%", background:`radial-gradient(circle,rgba(245,166,35,0.06),transparent 60%)`,
        filter:"blur(50px)", pointerEvents:"none" }}/>
      
      <div className="left-panel-logo" style={{ display:"flex", alignItems:"center", gap:10, marginBottom:32 }}>
        <Mark size={32}/><div>
      ...
      <div className="left-panel-title">
        <div style={{ fontSize:10, color:C.muted, letterSpacing:3, marginBottom:12 }}>GIFT CARDS</div>
        <div style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:30,
          letterSpacing:1, lineHeight:0.9, marginBottom:28 }}>
          SELL YOUR<br/>CARD FOR<br/><span style={{ color:C.amber }}>NAIRA</span>
        </div>
      </div>

      {/* Card visual preview */}
      {brand && (
        <div style={{ borderRadius:14, background:brand.bg,
          border:`1px solid ${brand.color}22`, padding:"18px 20px",
          marginBottom:18, position:"relative", overflow:"hidden",
          animation:"fadeIn 0.3s ease" }}>
          <div style={{ position:"absolute", right:-20, top:-20, width:100, height:100,
            borderRadius:"50%", background:`${brand.color}15`, filter:"blur(16px)" }}/>
          <div style={{ position:"absolute", inset:0, overflow:"hidden" }}>
            <div style={{ position:"absolute", top:0, left:"-30%", right:0, bottom:0,
              background:`linear-gradient(105deg,transparent,${brand.color}08,transparent)`,
              animation:"shimmer 3s 0.5s ease-in-out infinite" }}/>
          </div>
          <div style={{ fontSize:22, marginBottom:10 }}>{brand.icon}</div>
          <div style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:16,
            color:"rgba(255,255,255,0.85)", letterSpacing:2, marginBottom:4 }}>
            {brand.name.toUpperCase()}
          </div>
          {country && denom ? (
            <>
              <div style={{ fontFamily:"'DM Mono',monospace", fontSize:22,
                color:"#fff", fontWeight:500, letterSpacing:1 }}>
                {country.symbol}{denom}
              </div>
            ...
            <div style={{ fontSize:11, color:"rgba(255,255,255,0.35)", letterSpacing:1 }}>
              {country ? `${country.flag} ${country.currency}` : "Select denomination"}
            </div>
          )}
        </div>
      )}
        ...
        {showTicket ? (
          <div style={{ background:C.card, border:`1px solid ${C.border}`,
            ...
            <div style={{ padding:"10px 14px", borderBottom:`1px solid ${C.border}`,
              fontSize:10, color:C.muted, letterSpacing:2 }}>TRADE SUMMARY</div>
            <div style={{ padding:"0 14px" }}>
              {[
                { label:"Card",     val:brand?.name },
                { label:"Country",  val:country ? `${country.flag} ${country.code}` : null },
                { label:"Amount",   val:country&&denom ? `${country.symbol}${denom}` : null },
  ...
  return (
    <div className="step-form">
      ...
      <h2 style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:42,
        letterSpacing:1, lineHeight:0.9, marginBottom:8 }}>
        WHICH GIFT<br/><span style={{ color:C.amber }}>CARD DO YOU</span><br/>HAVE?
      </h2>
      ...
      <div className="brand-grid" style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:10 }}>
        {BRANDS.map(b => {
          const isSel = selected?.id === b.id;
          return (
            <button key={b.id} className={`brand-card${isSel?" sel":""}`}
              onClick={() => onSelect(b)}
              style={{ background:b.bg, border:`2px solid ${isSel?b.color:b.color+"22"}`,
              ...
              <span style={{ fontSize:11, fontWeight:600, color:"rgba(255,255,255,0.85)",
                textAlign:"center", lineHeight:1.3 }}>{b.name}</span>
              <span style={{ fontSize:9, color:b.textColor, fontFamily:"'DM Mono',monospace" }}>
...
// ─── STEP 2: DETAILS ──────────────────────────────────────
function StepDetails({ brand, country, setCountry, denom, setDenom, customAmt, setCustomAmt }) {
  const ngnOut = denom > 0 && country
    ? denom * country.rate
    : customAmt > 0 && country
    ? customAmt * country.rate
    : 0;
  ...
  return (
    <div className="step-form">
      ...
      <h2 style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:42,
        letterSpacing:1, lineHeight:0.9, marginBottom:8 }}>
        <span style={{ color:brand.color }}>{brand.name}</span><br/>CARD DETAILS
      </h2>
      ...
      {brand.countries.length > 1 && (
        <div style={{ marginBottom:20 }}>
          <div style={{ fontSize:10, color:C.muted, letterSpacing:2, marginBottom:10 }}>COUNTRY</div>
          <div style={{ display:"flex", gap:8 }}>
            {brand.countries.map(ct => (
              <button key={ct.code} className={`country-btn${country?.code===ct.code?" sel":""}`}
                onClick={() => { setCountry(ct); setDenom(0); setCustomAmt(""); }}
                style={{ display:"flex", alignItems:"center", gap:8,
                  padding:"10px 16px", borderRadius:10,
                  background: country?.code===ct.code?"rgba(14,203,129,0.08)":C.card2,
        ...
        <div style={{ marginBottom:20, animation:"fadeIn 0.2s ease" }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:8, marginBottom:12 }}>
            {country.denoms.map(d => (
              <button key={d} className={`denom-btn${denom===d?" sel":""}`}
                onClick={() => { setDenom(d); setCustomAmt(""); }}
                style={{ padding:"14px 8px", borderRadius:10, cursor:"pointer",
                ...
                <span style={{ fontSize:16, fontWeight:500 }}>{country.symbol}{d}</span>
                <span style={{ fontSize:10, color:denom===d?C.green:C.muted }}>
          ...
          <div style={{ position:"relative" }}>
            ...
            <input className="st-input" type="number" value={customAmt}
              onChange={e => { setCustomAmt(e.target.value); setDenom(0); }}
              placeholder="0"
      ...
      {/* NGN preview */}
      {ngnOut > 0 && (
        <div style={{ background:"rgba(245,166,35,0.06)",
...
function StepUpload({ image, setImage, cardCode, setCardCode }) {
  ...
  return (
    <div className="step-form">
      ...
      <h2 style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:42,
        letterSpacing:1, lineHeight:0.9, marginBottom:8 }}>
        UPLOAD YOUR<br/><span style={{ color:C.amber }}>CARD IMAGE</span>
      </h2>
      <p style={{ color:C.muted, fontSize:14, fontWeight:300,
        lineHeight:1.6, marginBottom:24 }}>
        Take a clear photo of the card showing the code and denomination. This helps us verify faster.
      </p>
      ...
      {!image ? (
        <div className={`upload-zone${drag?" drag":""}`}
          ...
          style={{ border:`2px dashed ${drag?"rgba(14,203,129,0.6)":C.border2}`,
        ...
        <div style={{ position:"relative", marginBottom:20, borderRadius:14, overflow:"hidden",
          border:`1px solid rgba(14,203,129,0.25)`, animation:"fadeIn 0.3s ease" }}>
          ...
          <div style={{ position:"absolute", bottom:12, left:16, right:16,
            ...
            <button onClick={() => setImage(null)}
              style={{ background:"rgba(246,70,93,0.15)",
                border:"1px solid rgba(246,70,93,0.3)",
                color:C.red, fontSize:11, padding:"5px 12px",
      ...
      <div style={{ marginBottom:20 }}>
        ...
        <input className="st-input" value={cardCode}
        ...
        <div style={{ fontSize:11, color:C.muted, marginTop:6 }}>
          Including the code speeds up verification. Not required if image is clear.
        </div>
      </div>
  ...
  return (
    <div className="step-form">
      ...
      <h2 style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:42,
        ...
        CONFIRM &<br/><span style={{ color:C.amber }}>SUBMIT</span>
      </h2>

      {/* Card preview */}
      <div style={{ background:brand.bg, border:`1px solid ${brand.color}22`,
        ...
        <div style={{ flex:1 }}>
          <div style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:18,
            letterSpacing:1, marginBottom:4 }}>{brand.name}</div>
          <div style={{ fontFamily:"'DM Mono',monospace", fontSize:22,
        ...
        <div style={{ textAlign:"right" }}>
          <div style={{ fontSize:10, color:C.amber, letterSpacing:2, marginBottom:4 }}>YOU RECEIVE</div>
          <div style={{ fontFamily:"'Bebas Neue',sans-serif",
            fontSize:28, color:C.amber, letterSpacing:1 }}>
      ...
      <div style={{ background:C.card, border:`1px solid ${C.border}`,
        ...
        {[
          ...
          <div key={k} style={{ display:"flex", justifyContent:"space-between",
            ...
            background:k==="You Receive"?"rgba(245,166,35,0.04)":"transparent" }}>
            <span style={{ fontSize:12, color:k==="You Receive"?C.amber:C.muted }}>{k}</span>
            <span style={{ fontFamily:"'DM Mono',monospace", fontSize:12,
              color:k==="You Receive"?C.amber:k==="Image"&&image?"#0ECB81":"#ccc",
              fontWeight:k==="You Receive"?600:400 }}>{v}</span>
          </div>
        ))}
      </div>

      <button onClick={onSubmit} disabled={loading} className="pri-btn"
        style={{ width:"100%", background:C.amber, color:"#000",
          fontWeight:700, fontSize:15, padding:"15px",
          borderRadius:12, border:"none", fontFamily:"'Outfit',sans-serif",
    ...
    <div className="step-form" style={{ textAlign:"center", padding:"16px 0" }}>
      <div style={{ position:"relative", width:96, height:96, margin:"0 auto 24px" }}>
        <div style={{ position:"absolute", inset:-8, borderRadius:"50%",
          border:`2px solid rgba(245,166,35,0.4)`, animation:"ripple 0.8s ease-out" }}/>
        <div style={{ position:"absolute", inset:-8, borderRadius:"50%",
          border:`2px solid rgba(245,166,35,0.2)`, animation:"ripple 0.8s 0.25s ease-out" }}/>
        <div style={{ width:96, height:96, borderRadius:"50%",
          background:"rgba(245,166,35,0.1)", border:`2px solid ${C.amber}`,
          display:"flex", alignItems:"center", justifyContent:"center",
          animation:"successIn 0.5s ease", boxShadow:`0 0 40px rgba(245,166,35,0.2)` }}>
          <svg width={40} height={40} viewBox="0 0 40 40" fill="none">
            <path d="M8 20l8 9L32 12" stroke={C.amber} strokeWidth={3}
      ...
      <div style={{ display:"inline-flex", alignItems:"center", gap:7,
        ...
        borderRadius:100, padding:"4px 14px", fontSize:10, color:C.amber,
        letterSpacing:3, marginBottom:16 }}>CARD SUBMITTED</div>

      <h2 style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:44,
        letterSpacing:1, lineHeight:0.9, marginBottom:12 }}>
        CARD RECEIVED.<br/><span style={{ color:C.amber }}>VERIFYING NOW.</span>
      </h2>

      <p style={{ color:C.muted, fontSize:14, lineHeight:1.7,
        maxWidth:340, margin:"0 auto 24px" }}>
        Your {trade.brand.name} {trade.country.symbol}{trade.denom||trade.customAmt} card is being verified.
        Once approved, <span style={{ color:C.amber, fontWeight:600 }}>
          ₦{trade.ngnOut.toLocaleString()}
        </span> will be credited to your wallet within 5–15 minutes.
      </p>

      <div style={{ background:C.card, border:`1px solid ${C.border}`,
        borderRadius:12, padding:"16px 20px", marginBottom:24, textAlign:"left" }}>
        <div style={{ fontSize:9, color:C.muted, letterSpacing:2, marginBottom:8 }}>REFERENCE ID</div>
        <div style={{ fontFamily:"'DM Mono',monospace", fontSize:20,
          color:C.amber, fontWeight:500, marginBottom:4 }}>{refId}</div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10 }}>
        <button onClick={onReset}
          style={{ background:C.amber, color:"#000", fontWeight:700,
        ...
        <Link to="/dashboard" className="ghost-btn"
          style={{ background:"transparent", border:`1px solid ${C.border2}`,
            ...
            fontFamily:"'Outfit',sans-serif", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", textDecoration:"none" }}>
          Dashboard →
        </Link>
      </div>
    </div>
...
export default function GiftCardsDashboard() {
  ...
  const [trade, setTrade] = useState({
    brand:null, country:null, denom:0,
    customAmt:"", image:null, cardCode:"",
  });
  ...
  // Set default country when brand changes
  useEffect(() => {
    if (trade.brand) upd({ country:trade.brand.countries[0], denom:0, customAmt:"" });
  }, [trade.brand?.id]);
  ...
  const canNext = () => {
    ...
    if (step==="details") return !!trade.country && (trade.denom>0 || parseFloat(trade.customAmt)>0);
  ...
  const handleReset = () => {
    setStep("brand");
    setTrade({ brand:null, country:null, denom:0, customAmt:"", image:null, cardCode:"" });
    setRefId("");
  };
  ...
  return (
    <div className="giftcards-container">
      ...
      <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden" }}>
        ...
        {/* Topbar */}
        <div className="giftcards-topbar" style={{ height:54, display:"flex", alignItems:"center",
        ...
        <div className="form-area">
          <div style={{ maxWidth:580, margin:"0 auto" }}>
            ...
            {step==="brand" && (
              <StepBrand selected={trade.brand}
                onSelect={b => upd({ brand:b })}/>
            )}
            {step==="details" && (
              <StepDetails brand={trade.brand}
                country={trade.country} setCountry={ct=>upd({country:ct,denom:0,customAmt:""})}
                denom={trade.denom} setDenom={d=>upd({denom:d,customAmt:""})}
                customAmt={trade.customAmt} setCustomAmt={v=>upd({customAmt:v,denom:0})}/>
            )}
            {step==="upload" && (
              <StepUpload image={trade.image} setImage={img=>upd({image:img})}
                cardCode={trade.cardCode} setCardCode={v=>upd({cardCode:v})}/>
            )}
            {step==="review" && (
              <StepReview trade={{ ...trade, ngnOut }} onSubmit={handleSubmit} loading={loading}/>
            )}
            {step==="done" && (
              <StepDone trade={{ ...trade, ngnOut }} refId={refId} onReset={handleReset}/>
            )}

            {/* Continue button for steps 1-3 */}
            {step!=="review" && step!=="done" && (
              <div style={{ marginTop:24 }}>
                <button disabled={!canNext()} onClick={next} className="pri-btn"
                  style={{ width:"100%",
