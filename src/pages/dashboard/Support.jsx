...
const FAQS = [
  ...
  { id:7, cat:"Withdrawals", q:"I requested a withdrawal but the money hasn't arrived. What do I do?", a:"Withdrawals are reviewed manually by our team before funds are sent, which can take some time. Your balance is debited as soon as you submit the request. If your withdrawal has stayed in 'Pending Review' for an unusually long time, contact support with your reference ID." },
  ...
  { id:9, cat:"Account", q:"How do I verify my account (KYC)?", a:"From your dashboard, go to KYC Verification, choose your ID type (NIN, Driver's License, Voter's Card, or International Passport), upload a photo of the document and a selfie, and submit. Our compliance team manually reviews submissions within 1–3 business days. Unverified accounts have limited withdrawal limits." },
