    ...
    >
      ...
      >
        <svg width={100} height={74} viewBox="0 0 120 88">
          ...
          />
          <path
            d="M4,16 L60,48 L116,16 Z"
            fill="#141414"
            stroke="#2a2a2a"
            strokeWidth={1}
            style={{
              transformOrigin: "60px 16px",
              transform: sent ? "rotateX(180deg)" : "rotateX(0deg)",
      ...
      <div
        style={{
          ...
          animation: sent
            ? "codeFloat 0.6s 0.3s ease forwards"
            : "float 3s 1s ease-in-out infinite",
          opacity: sent ? 1 : 0.9,
        }}
      >
    ...
    >
      <div
        style={{
          ...
          height: 440,
          borderRadius: "50%",
          background: `radial-gradient(circle,rgba(14,203,129,0.11),transparent 60%)`,
          filter: "blur(70px)",
          pointerEvents: "none",
      ...
      <div
        style={{
          ...
          opacity: 0.18,
          WebkitMaskImage:
            "radial-gradient(ellipse 80% 100% at 30% 50%,black,transparent 80%)",
        }}
      />
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          >
            {page === "register" ? (
              <>
                TRADE SMARTER.
                <br />
                <span style={{ color: C.green }}>START TODAY.</span>
              </>
            ) : (
              <>
                GOOD TO
                <br />
                <span style={{ color: C.green }}>SEE YOU.</span>
              </>
            )}
          </h2>
          ...
          >
            {page === "register"
              ? "Join thousands of Nigerians converting crypto and gift cards to naira — fast, safe, and completely transparent."
              : "Your portfolio is waiting. Log in to see your balances, trade, and withdraw to your bank."}
          </p>
    ...
    <div style={{ marginBottom: error ? 6 : 18 }}>
      <label
        style={{
          display: "block",
          fontSize: 11,
          color: focused ? C.green : error ? C.red : C.muted,
          letterSpacing: 2,
          marginBottom: 7,
      ...
      <div style={{ position: "relative" }}>
        <input
          ...
          style={{
            ...
            borderRadius: 10,
            padding: rightEl
              ? `${verticalPadding} 46px ${verticalPadding} ${horizontalPadding}`
        ...
        {[1, 2, 3, 4].map((i) => (
          <div
            ...
            style={{
              ...
              background: i <= score ? colors[score] : C.border2,
            }}
          />
        ))}
      </div>
          ...
          >
              ...
              style={{
                ...
                background: s.done
                  ...
                  : s.active
                    ...
                    : C.border2,
                border: s.active ? `1px solid rgba(14,203,129,0.4)` : "none",
                transition: "all 0.3s",
              }}
            >
              {s.done ? (
            ...
            <span
              style={{
                ...
                color: s.done ? C.green : s.active ? C.green : C.muted,
              }}
            >
              {s.label}
            </span>
          ...
          {i < steps.length - 1 && (
            <div
              style={{
                ...
                marginBottom: 20,
                background:
                  steps[i + 1].done || steps[i + 1].active ? C.green : C.border,
...
// ─── OTP SCREEN ───────────────────────────────────────────
function OTPScreen({ email, registerPayload, onSuccess, onBack }) {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      setTimeout(() => containerRef.current?.classList.remove("shake"), 400);
    }
  };
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      if (msg.toLowerCase().includes("already exists")) {
        setInfo(
          "Check your inbox and spam folder for the code sent when you registered.",
        );
      } else {
        setError(msg || "Could not resend code. Try again.");
      }
    } finally {
      setResending(false);
    }
  ...
  return (
    <div ref={containerRef} style={{ animation: "slideLeft 0.4s ease" }}>
      <button
        onClick={onBack}
        style={{
          background: "none",
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        >
          ...
          <span style={{ color: "#ccc", fontWeight: 500 }}>{email}</span>.
        </p>
      </div>
        ...
        {digits.map((d, i) => (
          <input
            ...
            style={{
              ...
              height: 50,
              maxWidth: 46,
              background: d ? "rgba(14,203,129,0.04)" : C.card,
              border: `1px solid ${d ? "rgba(14,203,129,0.35)" : C.border2}`,
              borderRadius: 12,
              textAlign: "center",
              fontFamily: "'DM Mono',monospace",
              fontSize: 20,
      ...
      <button
        ...
        style={{
          width: "100%",
          background: complete ? C.green : C.border,
          color: complete ? "#000" : C.muted,
          fontWeight: 700,
          fontSize: 15,
          padding: "15px",
          borderRadius: 12,
...
function SuccessView() {
  ...
  return (
    ...
    >
      ...
      >
        Welcome to Swift Trade. Your account is ready.
        <br />
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setErrors({
        email: "",
        password: "",
        general: getApiErrorMessage(err, "Invalid email or password"),
      });
      formRef.current?.classList.add("shake");
      setTimeout(() => formRef.current?.classList.remove("shake"), 400);
    }
...
function RegisterForm({ onSwitch }) {
  ...
  const validateForm = () => {
    ...
    if (!agreed) next.terms = "Agree to terms";
    return next;
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setErrors({
        ...fields,
        general:
          general || getApiErrorMessage(err, "Registration failed. Try again."),
      });
      formRef.current?.classList.add("shake");
      setTimeout(() => formRef.current?.classList.remove("shake"), 400);
    } finally {
  ...
  return (
    <div ref={formRef} className="auth-form">
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ color: C.muted, fontSize: 14, fontWeight: 300 }}>
          Takes under 2 minutes. No hidden fees, ever.
        </p>
      </div>
