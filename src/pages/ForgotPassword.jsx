...
const CSS = `
  ...
  *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
  ...
  @media (max-width: 1024px) {
    ...
    .right-panel-forgot { padding: clamp(24px, 4vw, 40px) clamp(16px, 3vw, 24px) !important; }
    .otp-container { gap: 8px !important; }
    .otp-box-input { height: 48px !important; font-size: clamp(14px, 2vw, 18px) !important; }
    .step-panel { padding: clamp(20px, 3vw, 28px) !important; }
  }

  @media (max-width: 768px) {
    .right-panel-forgot { padding: clamp(20px, 3vw, 28px) clamp(14px, 2vw, 18px) !important; }
    .st-input { padding: clamp(10px, 2vw, 12px) clamp(12px, 2vw, 14px) !important; font-size: 16px !important; }
    .otp-box-input { height: 48px !important; padding: 10px !important; font-size: 16px !important; }
    .pri-btn { min-height: 44px !important; font-size: clamp(14px, 2vw, 16px) !important; }
  }

  @media (max-width: 480px) {
    .right-panel-forgot { padding: clamp(16px, 2vw, 20px) !important; }
    .step-panel { padding: clamp(12px, 2vw, 16px) !important; }
    .otp-container { gap: 6px !important; }
    .otp-box-input { height: 44px !important; font-size: 16px !important; }
    .pri-btn { min-height: 48px !important; padding: clamp(12px, 2vw, 14px) !important; }
  }
`;
            ...
            >
              <div
                style={{
                  ...
                  boxShadow: active
                    ? `0 0 0 4px rgba(14,203,129,0.07)`
                    : "none",
                  transition: "all 0.3s",
                }}
              >
...
function Field({
  ...
  const cls = ["st-input", error ? "err" : valid && !error ? "ok" : ""]
    .join(" ")
    .trim();
  return (
    <div style={{ marginBottom: error ? 6 : 18 }}>
      ...
      <div style={{ position: "relative" }}>
        <input
          ...
          style={{
            ...
            borderRadius: 11,
            padding: right ? "13px 46px 13px 16px" : "13px 16px",
            color: "#fff",
            fontSize: 15,
          }}
        />
      ...
      {error && (
        ...
        >
          <svg width={11} height={11} viewBox="0 0 11 11">
            <circle cx="5.5" cy="5.5" r="5.5" fill={C.red} />
            <path
      ...
      {hint && !error && (
        <div style={{ fontSize: 11, color: C.muted2, marginTop: 5 }}>
          {hint}
        </div>
      )}
    </div>
...
function Strength({ pw }) {
  ...
  return (
    <div style={{ marginBottom: 16 }}>
      ...
      <span style={{ fontSize: 10, color: cols[score], letterSpacing: 1 }}>
        {labs[score]} password
      </span>
    </div>
  );
    ...
    <div className="step-panel">
      <div style={{ marginBottom: 32 }}>
        ...
        >
          FORGOT YOUR
          <br />
          <span style={{ color: C.green }}>PASSWORD?</span>
        </h1>
        <p
          style={{
            color: C.muted,
        ...
        >
          Enter the email linked to your Swift Trade account. We'll send a
      ...
      >
        ...
        >
          A 6-digit OTP will be sent to this email. It expires in{" "}
          <span style={{ color: "#bbb" }}>10 minutes</span>.
        </span>
      </div>
      ...
      >
        ...
        <span style={{ fontSize: 11, color: C.muted2, letterSpacing: 1 }}>
          OR
        </span>
        <div style={{ flex: 1, height: 1, background: C.border }} />
      </div>
    ...
    <div className="step-panel">
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        >
          ENTER YOUR
          <br />
          <span style={{ color: C.green }}>OTP CODE</span>
        </h1>
        <p
          style={{
            color: C.muted,
      ...
      <div style={{ height: 20, marginBottom: 14 }}>
        {badCode && (
          ...
          >
            ...
            Incorrect code. {Math.max(0, 3 - attempts)} attempt
            {Math.max(0, 3 - attempts) !== 1 ? "s" : ""} remaining.
          </div>
        )}
        {!badCode && timer === 0 && (
          <div
...
function StepPassword({ email, token, onNext, onBack }) {
    ...
    try {
      ...
      setErrors({
        ...
        api:
          err.response?.data?.message ||
          err.response?.data?.detail ||
          "Invalid token or error resetting password.",
      });
    }
  };
  ...
  return (
    <div className="step-panel">
      ...
      <Btn onClick={submit} disabled={!pw || !cpw} loading={loading}>
        Reset Password
        <svg
          width={15}
          height={15}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            inset: -6,
            borderRadius: "50%",
            border: `2px solid rgba(14,203,129,0.15)`,
            animation: "ripple 1s 0.2s ease-out",
          }}
        />
        <div
          style={{
      ...
      >
        ALL DONE!
        <br />
        <span style={{ color: C.green }}>YOU'RE IN.</span>
      </h2>
      ...
      >
        Your password has been reset. You can now log in to your Swift Trade
...
const LEFT_COPY = [
  {
    title: "FORGOT\nYOUR\nPASSWORD?",
    sub: "Enter your registered email and we'll send you a code to get back in.",
    lockStep: 0,
  },
  {
    title: "CHECK\nYOUR\nINBOX",
    sub: "A 6-digit code is on its way. Enter it to verify your identity.",
    lockStep: 1,
  },
  {
    title: "ALMOST\nTHERE",
    sub: "Set a strong new password. Make it something you haven't used before.",
    lockStep: 2,
  },
  {
    title: "ACCESS\nRESTORED",
    sub: "You're all set. Welcome back to Swift Trade.",
    lockStep: 3,
  },
];
    ...
    >
      <div
        style={{
          ...
          height: 400,
          borderRadius: "50%",
          background: `radial-gradient(circle,rgba(14,203,129,0.09),transparent 60%)`,
          filter: "blur(70px)",
          pointerEvents: "none",
      ...
      <div
        style={{
          ...
          opacity: 0.15,
          WebkitMaskImage:
            "radial-gradient(ellipse 80% 80% at 50% 50%,black,transparent 80%)",
        }}
      />
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 16,
              borderRadius: "50%",
              border: `1px dashed rgba(14,203,129,0.1)`,
            ...
            <>
              ...
              <div
                style={{
                  ...
                  animation: "ripple 1s 0.3s ease-out",
                }}
              />
            </>
          )}
          ...
          <div
            style={{
              filter: unlocked
                ? `drop-shadow(0 0 20px ${C.green}55)`
                : "drop-shadow(0 8px 20px rgba(0,0,0,0.5))",
              animation: unlocked
                ? "none"
                : "floatRock 5s ease-in-out infinite",
          ...
          >
            <svg width={88} height={108} viewBox="0 0 88 108">
              <defs>
                <linearGradient id="lb2" x1="0" y1="0" x2="0" y2="1">
                  <stop
                    offset="0%"
                    stopColor={
                      done ? "#0ECB81" : unlocked ? "#0ECB81" : "#1c1c1c"
                    }
                  />
                  <stop
                    offset="100%"
                    stopColor={
                      done ? "#069f5f" : unlocked ? "#0a8050" : "#101010"
                    }
                  />
                </linearGradient>
              </defs>
              ...
              >
                <path
                  d="M22,40 L22,22 Q22,8 44,8 Q66,8 66,22 L66,40"
                  fill="none"
                  stroke={unlocked ? C.green : "#2a2a2a"}
                  strokeWidth={8}
                  strokeLinecap="round"
              ...
              <rect
                ...
                rx={1}
                fill={
                  unlocked ? "rgba(14,203,129,0.6)" : "rgba(255,255,255,0.04)"
                }
